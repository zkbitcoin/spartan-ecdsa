...
export class CircuitPubInput {
    constructor(merkleRoot, Tx, Ty, Ux, Uy) {
...
export class PublicInput {
    constructor(r, v, msgHash, circuitPubInput) {
        this.r = r;
        this.rV = v;
    ...
    serialize() {
        const circuitPubInput = this.circuitPubInput.serialize();
    ...
    static deserialize(serialized) {
        ...
        const circuitPubInput = CircuitPubInput.deserialize(serialized.slice(32 + 1, 32 + 1 + 32 * 5));
 ...
 */
export const verifyEffEcdsaPubInput = ({ r, rV, msgHash, circuitPubInput }) => {
